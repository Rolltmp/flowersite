        ...
        <div class="row" style="margin-bottom: 20%">
            ...
            <div class="col-sm-5">
                ...
                <form action="${pageContext.request.contextPath}/reg" method="post">
                    <div class="form-group">
                        <input type="text" class="form-control" name="reg_name" placeholder="${sessionScope.lang['name']}">
                    </div>
                    <div class="form-group">
                        <label></label>
                    ...
                    <div class="form-group">
                        <label></label>
                        <input type="password" class="form-control" name="reg_pass" placeholder="${sessionScope.lang['pass']}">
                    </div>
                    <div class="form-group">
                        <label></label>
                        <input type="text" class="form-control" name="reg_phone" placeholder="${sessionScope.lang['phone']}">
                    </div>
