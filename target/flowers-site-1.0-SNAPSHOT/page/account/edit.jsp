    ...
    <div class="container">
        ...
        <div class="col-sm-12">
            ...
            <div class="form-group">
                <input type="text" id="name" class="form-control" value="${sessionScope.user.userName}">
            </div>
            <h4>${sessionScope.lang['pass']}</h4>
            <div class="form-group">
                <input type="text" id="phone" class="form-control" value="${sessionScope.user.userPhone}">
            </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="form-group">
                <input class="form-control" type="password" id="password_2" value="">
            </div>
